<x-admin-layout>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 py-12">
        ...
        <section class="grid grid-cols-4 gap-6 text-white">
            ...
            <a href="{{ route('admin.orders.index') . "?status=2" }}" class="bg-indigo-500 bg-opacity-75 rounded-lg px-12 pt-8 pb-4">
            ...
            <a href="{{ route('admin.orders.index') . "?status=4" }}" class="bg-teal-500 bg-opacity-75 rounded-lg px-12 pt-8 pb-4">
                <p class="text-center text-2xl">
                    {{$entregado}}
                </p>
            ...
            <a href="{{ route('admin.orders.index') . "?status=5" }}" class="bg-gray-500 bg-opacity-75 rounded-lg px-12 pt-8 pb-4">
                <p class="text-center text-2xl">
                    {{$anulado}}
                </p>
            ...
            <section class="bg-white shadow-lg rounded-lg px-12 py-8 mt-12 text-gray-700">
                ...
                <ul>
                    @foreach ($orders as $order)
                        <li>
                            <a href="{{route('admin.orders.show', $order)}}" class="flex items-center py-2 px-4 hover:bg-gray-200 rounded-lg">
