<div class="py-12 bg-cover" style="background-image:url('/img/fondo3.png');">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class=" overflow-hidden shadow-xl sm:rounded-lg ring-4">

            <div class="p-6 sm:px-20 bg-gray-600 bg-opacity-80 border-b border-gray-200">
                <div>
                    <x-jet-application-logo class="block h-24 w-auto" />
                </div>

                <div class="text-gray-100 mt-8 text-2xl">
                    Bienvenido a la Aplicación Web de Fruitcas !
                </div>

                <div class="mt-6 text-gray-100">
                    Nuestro objetivo general es cultivar y comercializar frutas tropicales, de producción regional, en
                    especial la
                    piña Gold MD2, frutas producidas acordes a las condiciones climáticas de nuestra zona, aprovechando
                    los recursos
                    naturales y dentro de los estándares de producción amigable del medio ambiente, con la más alta
                    calidad y buen
                    precio, generando empleo en el municipio de Tauramena y sirviendo como ejemplo para los productores
                    del campo.
                </div>
            </div>

            <div class="bg-gray-200 bg-opacity-90 grid grid-cols-1 md:grid-cols-2">
                <div class="p-6">
                    ...
                    <div class="ml-12">
                        <div class="mt-2 text-sm text-gray-500">
                            ...
                            new to the
                            framework or have previous experience, we recommend reading all of the documentation from
                            beginning to
                            end.
                        </div>
                ...
                <div class="p-6 border-t border-gray-200">
                    ...
                    <div class="ml-12">
                        <div class="mt-2 text-sm text-gray-500">
                            ...
                            doesn't get in
                            your way. You'll be amazed how easily you can build and maintain fresh, modern designs with
                            this
                ...
                <div class="p-6 border-t border-gray-200 md:border-l">
                    ...
                    <div class="ml-12">
                        <div class="mt-2 text-sm text-gray-500">
                            ...
                            support for user
                            email verification and resetting forgotten passwords. So, you're free to get started what
                            matters most:
        ...
        <div class="my-12 overflow-hidden shadow-xl sm:rounded-lg ring-4">
            <div class="p-6 sm:px-20 bg-gray-600 bg-opacity-80 border-b border-gray-200">
                <div>
                    <x-jet-application-logo class="block h-24 w-auto" />
                </div>
