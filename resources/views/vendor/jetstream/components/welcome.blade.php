<div class="p-6 sm:px-20 bg-gray-200 border-b border-gray-200">
    <div>
        <x-jet-application-logo class="block h-24 w-auto text-white" />
    </div>

    <div class="text-gray-800 mt-8 text-2xl">
        Bienvenido a la Aplicación Web de Fruitcas !
    </div>

    <div class="mt-6 text-gray-500">
        Nuestro objetivo general es cultivar y comercializar frutas tropicales, de producción regional, en especial la
        piña Gold MD2, frutas producidas acordes a las condiciones climáticas de nuestra zona, aprovechando los recursos
        naturales y dentro de los estándares de producción amigable del medio ambiente, con la más alta calidad y buen
        precio, generando empleo en el municipio de Tauramena y sirviendo como ejemplo para los productores del campo.
    </div>
</div>
