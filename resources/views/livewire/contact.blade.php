                ...
                <section class="text-gray-600 body-font relative">
                    ...
                    <div class="container px-5 py-24 mx-auto flex">
                        <div class="lg:w-1/3 md:w-1/2 bg-white rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10 shadow-md">
                            <h2 class="text-gray-900 text-lg mb-1 font-medium title-font">FruitCas</h2>
                            <p class="leading-relaxed mb-5 text-gray-600">Comunicate con nosotros</p>
                            <div class="relative mb-4">
                                <label for="email" class="leading-7 text-sm text-gray-600">Correo Electroníco</label>
                            ...
                            <p class="text-xs text-gray-500 mt-3">Gracias por contactarnos.</p>
                        </div>
                    </div>
                </section>
