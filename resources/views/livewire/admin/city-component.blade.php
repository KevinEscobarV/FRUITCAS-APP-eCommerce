<div>
    <x-slot name="header">
        <div class="flex items-center">
            ...
            <div class="ml-4 text-lg text-gray-500 leading-7 font-semibold"> Ciudad: {{ $city->name }}
            </div>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 py-12">
        ...
        @can('departments.create')
            <x-jet-form-section submit="save" class="mb-6">
                ...
                <x-slot name="title">
                    Agregar una nueva zona o barrio.
                </x-slot>

                <x-slot name="description">
                    Complete la información necesaria para poder agregar una nueva zona o barrio.
                </x-slot>
                ...
                <x-slot name="actions">
                    ...
                    <x-jet-action-message class="mr-3" on="saved">
                        Zona o Barrio agregado correctamente.
        ...
        <x-jet-action-section>
            <x-slot name="title">
                Lista de zonas o barrios.
            </x-slot>

            <x-slot name="description">
                Aquí encontrará todas las zonas o barrios agregados.
            </x-slot>
