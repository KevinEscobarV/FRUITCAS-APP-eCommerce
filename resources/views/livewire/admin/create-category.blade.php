    ...
    @can('categories.create')
        <x-jet-form-section submit="save" class="mb-6">
            ...
            <x-slot name="form">
                ...
                <div class="col-span-6 sm:col-span-4">
                    <x-jet-label>
                        Ícono | Dirigete a <a href="https://fontawesome.com/icons" class=" cursor-pointer text-teal-500"
                            target="blank">FontAwesome</a> y copia el link del ícono deseado.
                    </x-jet-label>
                                ...
                                <div class="flex divide-x divide-gray-300 font-semibold">
                                    ...
                                    @can('categories.destroy')
                                        <a class="pl-2 hover:text-red-600 cursor-pointer"
                                            wire:click="$emit('deleteCategory', '{{ $category->slug }}')">Eliminar
                                        </a>
                                    @endcan
