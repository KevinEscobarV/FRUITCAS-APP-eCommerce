...
<div class="max-w-7xl mx-auto sm:px-6 lg:px-8 py-8 grid grid-cols-5 gap-6">
    <div class="col-span-3">
            ...
            <div class="bg-white rounded-lg shadow">
                ...
                <div class="px-6 pb-6 grid grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select class="w-full rounded-md" wire:model="department_id">
                    ...
                    <div>
                        ...
                        <select class="w-full rounded-md" wire:model="city_id">
        ...
        <div>
            ...
            <p class="text-sm text-gray-700 mt-2">A continuación se generara una orden de productos en su cuenta con la que podrá llevar seguimiento de esta cuando lo desee, tendrá diferentes medios con los que podrá realizar el pago.
