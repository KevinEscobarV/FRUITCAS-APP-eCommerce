            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="px-4 py-5 sm:px-6 items-center flex justify-between">
                    ...
                    <p class="mt-1 max-w-2xl text-sm text-gray-500">
                        Editar nombre y permisos al Rol
                    </p>
                    </div>
                    <div>
...
@include('roles.partials.form')
                    ...
                    <div class="px-4 py-5 bg-gray-100 text-right sm:px-6">
                        {!! Form::submit('Editar Rol', ['class' => 'inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500']) !!}
                    </div>
